...
class PL_Combine_Dynamic_EOD(BaseMethod):
    ...
    def __init__(self, model_class, device, plotting_interval=100):
        ...
        self.combiner = OracleCombinerDynamicEOD()
        # set_seed(42)
    ...
    def fit_combiner(self, dataloader):
        ...
        self.combiner.fit(class_probs_all, hum_preds_all, truths_all, demographics_all)
