...
class CompareConfidence(BaseMethod):
    ...
    def fit_epoch_class(self, dataloader, optimizer, verbose=True, epoch=1):
        ...
        for batch, (data_x, data_y, hum_preds, demographic) in enumerate(dataloader):
    ...
    def fit_epoch_expert(self, dataloader, optimizer, verbose=True, epoch=1):
        ...
        for batch, (data_x, data_y, hum_preds, demographic) in enumerate(dataloader):
            ...
            hum_equal_to_y = hum_equal_to_y.to(self.device)
    ...
    def test(self, dataloader):
        ...
        with torch.no_grad():
            for batch, (data_x, data_y, hum_preds, demographic) in enumerate(dataloader):
                ...
                demographics_all.extend(demographic.cpu().numpy())
                defers = []
